export default class cdbeChat {
    ...
    static _spendKarma (event, data){
      ...
      const archivo_template = '/systems/cdbe/templates/chat/test-result-karma.html';
    ...
    static _gainResolve (event, data){
      ...
      const messageId = $(element)
            ...
            .attr('data-message-id');
      const message = game.messages.get(messageId)
      let msg_content="<div class=\"cdbe test-result\"><h3 class=\"disabled\">"+game.i18n.localize("TRI.ui.acceptIntrusion")+"</h3></div>"
