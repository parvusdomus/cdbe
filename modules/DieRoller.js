...
export default class DieRoller extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        if (game.user.isGM==true){
            template="systems/cdbe/templates/dialogs/dice-rollerGM.html"
        }
        else{
            template="systems/cdbe/templates/dialogs/dice-roller.html"
        }
        return mergeObject(super.defaultOptions, {
            id: "die-roller",
            title: game.i18n.localize("cdbe.system.dieRoller"),
            template: template,
            classes: [ "cdbe", "die-roller"],
            popout: false,
            buttons: [],
        });
    }
    ...
    getPos() {
        this.pos = game.user.getFlag("cdbe", "dieRollerPosition");
        ...
        if (!this.pos || (this.pos.length === 0)) {
            ...
            game.user.setFlag("cdbe", "dieRollerPosition", this.pos);
        }
    ...
    async _onIntrussion(event)
    {
        ...
        {
            msg_content="<div class=\"cdbe test-result\"><h3 class=\"enabled\">"+game.i18n.localize("TRI.ui.proposeIntrusion")+"</h3></div>"
            if (event.shiftKey) {
                msg_content+="<div class=\"cdbe test-result\"><a class=\"gainResolve\" data-actor_id="+actor._id+" data-current_resolve="+actor.system.resources.resolve.value+"><h3 class=\"resolve-button\">"+game.i18n.localize("TRI.ui.resolveIntrusion")+"</h3></a></div>"
            ...
            {
                msg_content+="<div class=\"cdbe test-result\"><a class=\"gainKarma\" data-actor_id="+actor._id+" data-current_karma="+actor.system.resources.karma.value+"><h3 class=\"karma-button\">"+game.i18n.localize("TRI.ui.karmaIntrusion")+"</h3></a></div>"
        ...
        if (actor.type=="Player")
        {
            ...
            if (event.shiftKey) {
                ...
                if (resolve < 0){resolve=0}
                    ...
                    msg_content="<div class=\"cdbe test-result\"><h3 class=\"resolve-button\">"+game.i18n.localize("TRI.ui.loseResolve")+"</h3></div>"
                    chatData = {
                        content: msg_content,
                        speaker: ChatMessage.getSpeaker()
                    };
        ...
        if (actor.type=="Player")
        {
            ...
            if (event.shiftKey) {
                ...
                if (karma < 0){karma=0}
                    ...
                    msg_content="<div class=\"cdbe test-result\"><h3 class=\"karma-button\">"+game.i18n.localize("TRI.ui.loseKarma2")+"</h3></div>"
                    chatData = {
                        content: msg_content,
                        speaker: ChatMessage.getSpeaker()
                    };
